...
export default async function Home() {
  const { stargazers_count: stars } = await fetch(
    "https://api.github.com/repos/steven-tey/Beacon",
    {
      ...
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        >
          ...
          <a
            ...
            href="https://github.com/steven-tey/Beacon"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Github />
...
const features = [
  ...
  },
  {
    ...
    description:
      "Jumpstart your next project by deploying Beacon to [Vercel](https://vercel.com/) in one click.",
    demo: (
      <a href={DEPLOY_URL}>
        <Image
  ...
  },
  {
    title: "Built-in Auth",
    description:
      "Beacon comes with authentication via [Clerk](https://clerk.com/)",
    demo: (
  ...
  },
  {
    ...
    description:
      "Beacon offers a collection of hooks, utilities, and `@vercel/og`",
    demo: (
